...
if __name__ == '__main__':
  ...
  respath = '/scratch/xf362/yilin_revised_pipeline_siamense/C3D_pairwise_eval/res_matrix/optimal_path/'
      ...
      if re.search('.mp4',video_file1) is not None:
         ...
         for video_file2 in sort(os.listdir(videopath+scene_name)):
           if re.search('.mp4',video_file2) is not None:
              ...
              #if video_name1 == 'car_on_fire1' and video_name2 == 'car_on_fire3':
                # pdb.set_trace()
  ...
  scipy_io.savemat(open(respath+scene_name+'.op.mat','wb'),res) 
  print 1
